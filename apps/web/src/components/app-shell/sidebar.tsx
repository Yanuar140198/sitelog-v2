...
import { LayoutDashboard, FolderKanban, Calculator, Truck, ClipboardList, BarChart3, Settings, ShieldCheck, FileStack, Wrench, HardHat, Briefcase, Sparkles } from 'lucide-react';
...
/**
 * Shared nav links list, reused by both the static desktop Sidebar and the
 * mobile slide-in drawer (see mobile-nav.tsx). `onNavigate` lets the drawer
...
export function Sidebar() {
  return (
    // Hidden on mobile; the mobile drawer (mobile-nav.tsx) takes over below md.
    <aside className="row-span-2 hidden md:flex bg-[var(--color-ink)] text-white border-r-2 border-[var(--color-ink)] flex-col">
